...
window.history.pushState(null,null, newPath);
        ...
        let scream = this.props.screamId.toString();
        this.props.getScream(scream);
    }
    handleClose = () => {
     ...
     render() {
         ...
         const { classes, scream: {createdAt, userHandle, body, screamId, userImage, commentCount, likeCount, comments}, UI: {loading}} =this.props;
